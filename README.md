...
3. Task Prioritization: Allows users to prioritize tasks for better task management.
4. Local Storage Persistence: Ensures tasks remain available even after closing the browser, without requiring a backend.
5 . Interactive UI: Combines animations, hover effects, and a blur effect during task addition for an engaging experience.
